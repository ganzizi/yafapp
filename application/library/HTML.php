...
class HTML {
    ...
    {
        return htmlspecialchars( (string) $value, ENT_QUOTES, Elephant::$charset, $double_encode);
    }
    ...
    {
        return htmlentities( (string) $value, ENT_QUOTES, Elephant::$charset, $double_encode);
    }
