...
class Query {
	...
	public function execute($db = NULL, $as_object = NULL, $object_params = NULL)
	{
	 ...
	 // 2014-04-22 09:52:52 星期二
    public function pagination($per_page=null, $config='default')
    {
        return Pagination::factory($this, $per_page, 'select', $config);
    }
